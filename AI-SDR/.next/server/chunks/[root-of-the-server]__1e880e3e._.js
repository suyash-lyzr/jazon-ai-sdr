module.exports = [
"[project]/.next-internal/server/app/api/test-db/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            environment: {
                ...
                uriPreview: mongoUri ? `${mongoUri.split("@")[0]}@${mongoUri.split("@")[1]?.split("/")[0]}...` : "not set"
            }
        }, {
            status: 200
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e880e3e._.js.map