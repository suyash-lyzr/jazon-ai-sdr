    ...
    const openEditSidebar = (section)=>{
        ...
        if (section === "company") {
            initialData = {
                ...
                employee_count: selectedLeadData.company?.company_size?.employee_count || "",
                annual_revenue_usd: selectedLeadData.company?.company_size?.annual_revenue_usd || "",
            ...
            initialData = {
                ...
                responsibilities: (selectedLeadData.persona?.responsibilities || []).join("\n"),
                pain_points: (selectedLeadData.persona?.pain_points || []).join("\n"),
                decision_authority_rationale: safeString(selectedLeadData.persona?.decision_authority?.rationale),
                decision_maker_likelihood: safeString(selectedLeadData.persona?.decision_authority?.decision_maker_likelihood)
            };
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0b9955e._.js.map