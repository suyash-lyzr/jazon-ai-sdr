...
async function GET(request, { params }) {
    try {
        ...
        const lead = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Lead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!lead) {
        ...
        console.log(`✅ Found lead: ${lead.lead_input.name}`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            lead: lead
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec0ddcae._.js.map